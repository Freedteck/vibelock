...
export const mockTracks: Track[] = [
  {
    ...
    artwork: "https://images.pexels.com/photos/1144261/pexels-photo-1144261.jpeg?auto=compress&cs=tinysrgb&w=300",
    coinPrice: 0.0025,
    holders: 89,
    isUnlocked: false,
    ...
    maxSupply: 1000,
    currentSupply: 89,
    description: "A synthwave journey through neon-lit streets and midnight highways. This track captures the essence of retro-futuristic vibes with modern production.",
    collaborators: [
  ...
  },
  {
    ...
    maxSupply: 800,
    currentSupply: 156,
    description: "Ethereal ambient soundscapes that transport you to a world of neon-lit dreams and cosmic wonder.",
    collaborators: [
  ...
  },
  {
    ...
    artwork: "https://images.pexels.com/photos/2246476/pexels-photo-2246476.jpeg?auto=compress&cs=tinysrgb&w=300",
    coinPrice: 0.0018,
    holders: 234,
    isUnlocked: false,
    ...
    maxSupply: 1200,
    currentSupply: 234,
    description: "Urban beats that capture the pulse of the city. Raw energy meets polished production in this hip-hop masterpiece.",
    collaborators: [
  ...
  },
  {
    ...
    artwork: "https://images.pexels.com/photos/1001682/pexels-photo-1001682.jpeg?auto=compress&cs=tinysrgb&w=300",
    coinPrice: 0.0042,
    holders: 67,
    isUnlocked: true,
    ...
    maxSupply: 500,
    currentSupply: 67,
    description: "Immersive ocean soundscapes with gentle waves and ambient textures for deep relaxation.",
    collaborators: [
  ...
  },
  {
    ...
    maxSupply: 900,
    currentSupply: 198,
    description: "High-energy techno with pulsing basslines and electric synths that will move any dancefloor.",
    collaborators: [
  ...
  },
  {
    ...
    artwork: "https://images.pexels.com/photos/1629236/pexels-photo-1629236.jpeg?auto=compress&cs=tinysrgb&w=300",
    coinPrice: 0.0028,
    holders: 143,
    isUnlocked: true,
    ...
    maxSupply: 750,
    currentSupply: 143,
    description: "Dreamy indie melodies that capture the magic of starlit nights and cosmic wonder.",
    collaborators: [
  ...
  },
  {
    ...
    previewUrl: audioUrls.preview[0],
    fullUrl: audioUrls.full[0],
    artwork: "https://images.pexels.com/photos/2047905/pexels-photo-2047905.jpeg?auto=compress&cs=tinysrgb&w=300",
    coinPrice: 0.0022,
    holders: 112,
    isUnlocked: false,
    ...
    maxSupply: 600,
    currentSupply: 112,
    description: "Futuristic electronic beats that paint a picture of tomorrow's digital landscape.",
    collaborators: [
      { name: "Cyber Dreams", role: "Artist", percentage: 100 }
    ],
    tradingHistory: [
  ...
  },
  {
    ...
    maxSupply: 400,
    currentSupply: 78,
    description: "Smooth jazz melodies under the moonlight, perfect for late-night contemplation.",
    collaborators: [
...
export const mockArtists: Artist[] = [
  {
    ...
    banner: "https://images.pexels.com/photos/1144261/pexels-photo-1144261.jpeg?auto=compress&cs=tinysrgb&w=800",
  ...
  },
  {
    ...
    name: "Luna Beats",
    avatar: "https://images.pexels.com/photos/1239291/pexels-photo-1239291.jpeg?auto=compress&cs=tinysrgb&w=150",
    banner: "https://images.pexels.com/photos/1190298/pexels-photo-1190298.jpeg?auto=compress&cs=tinysrgb&w=800",
  ...
  },
  {
    ...
    name: "Digital Nomad",
    avatar: "https://images.pexels.com/photos/1239291/pexels-photo-1239291.jpeg?auto=compress&cs=tinysrgb&w=150",
    banner: "https://images.pexels.com/photos/2246476/pexels-photo-2246476.jpeg?auto=compress&cs=tinysrgb&w=800",
  ...
  },
  {
    ...
    name: "Voltage",
    avatar: "https://images.pexels.com/photos/1239291/pexels-photo-1239291.jpeg?auto=compress&cs=tinysrgb&w=150",
    banner: "https://images.pexels.com/photos/1763075/pexels-photo-1763075.jpeg?auto=compress&cs=tinysrgb&w=800",
...
export const genres = [
  "Electronic", "Hip-Hop", "Indie", "Ambient", "House", "Techno", "R&B", "Pop", "Rock", "Jazz"
];
